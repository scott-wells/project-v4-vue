<template>
    ...
    <div class="lg:px-20 text-brown-primary font-thin">
        ...
        <div class="pb-10 flex flex-col sm:flex-row sm:items-center gap-8 sm:items-start ">
            <div class="pb-8 sm:w-2/3">
                <p class="pb-4">
            ...
            <div class="sm:w-1/3 max-w-56 border-4 border-brown-primary overflow-hidden rounded-full ">
                <img src="../assets/images/sw-profile-pic-sm.jpg" alt="profile image"/>
            </div>
        </div>
        <div class="sm:w-5/6 p-6 sm:p-8 bg-offwhite-primary border-2 border-brown-primary box-shad">
